...
class TypeMapperTest {
    ...
    void evalPredicate() {
        // success checks
        assertTrue(mapper.evalPredicate((obj) -> obj instanceof String, getParameters().get(PARAMS_KEY_STRING)));
        assertTrue(mapper.evalPredicate(Objects::isNull, null));

        // fail checks
        assertFalse(mapper.evalPredicate((obj) -> obj instanceof Integer, getParameters().get(PARAMS_KEY_STRING)));
    }
    ...
    void map2() {
        ...
        assertEquals(getParameters().get(PARAMS_KEY_BIG_DECIMAL),
                mapper.map(getParameters().get(PARAMS_KEY_BIG_DECIMAL)));
        assertEquals(getParameters().get(PARAMS_KEY_BIG_DECIMAL_STRING),
                mapper.map(getParameters().get(PARAMS_KEY_BIG_DECIMAL_STRING)));
        assertEquals(getParameters().get(PARAMS_KEY_BIG_INTEGER),
                mapper.map(getParameters().get(PARAMS_KEY_BIG_INTEGER)));
        assertEquals(getParameters().get(PARAMS_KEY_BIG_INTEGER_STRING),
                mapper.map(getParameters().get(PARAMS_KEY_BIG_INTEGER_STRING)));
        assertEquals(getParameters().get(PARAMS_KEY_BOOLEAN), mapper.map(getParameters().get(PARAMS_KEY_BOOLEAN)));
        assertEquals(getParameters().get(PARAMS_KEY_BOOLEAN_STRING),
                mapper.map(getParameters().get(PARAMS_KEY_BOOLEAN_STRING)));
        assertEquals(getParameters().get(PARAMS_KEY_BYTE), mapper.map(getParameters().get(PARAMS_KEY_BYTE)));
        assertEquals(getParameters().get(PARAMS_KEY_BYTE_STRING),
                mapper.map(getParameters().get(PARAMS_KEY_BYTE_STRING)));
        assertEquals(getParameters().get(PARAMS_KEY_CALENDAR), mapper.map(getParameters().get(PARAMS_KEY_CALENDAR)));
        assertEquals(getParameters().get(PARAMS_KEY_CALENDAR_STRING),
                mapper.map(getParameters().get(PARAMS_KEY_CALENDAR_STRING)));
        ...
        assertEquals(getParameters().get(PARAMS_KEY_LOCALDATE_STRING),
                mapper.map(getParameters().get(PARAMS_KEY_LOCALDATE_STRING)));
        assertEquals(getParameters().get(PARAMS_KEY_LOCALDATETIME),
                mapper.map(getParameters().get(PARAMS_KEY_LOCALDATETIME)));
        assertEquals(getParameters().get(PARAMS_KEY_LOCALDATETIME_STRING),
                mapper.map(getParameters().get(PARAMS_KEY_LOCALDATETIME_STRING)));
        assertEquals(getParameters().get(PARAMS_KEY_LOCALTIME), mapper.map(getParameters().get(PARAMS_KEY_LOCALTIME)));
        assertEquals(getParameters().get(PARAMS_KEY_LOCALTIME_STRING),
                mapper.map(getParameters().get(PARAMS_KEY_LOCALTIME_STRING)));
        assertEquals(getParameters().get(PARAMS_KEY_LONG), mapper.map(getParameters().get(PARAMS_KEY_LONG)));
        assertEquals(getParameters().get(PARAMS_KEY_LONG_STRING),
                mapper.map(getParameters().get(PARAMS_KEY_LONG_STRING)));
        ...
        assertEquals(getParameters().get(PARAMS_KEY_SHORT_STRING),
                mapper.map(getParameters().get(PARAMS_KEY_SHORT_STRING)));
        assertEquals(getParameters().get(PARAMS_KEY_STRING), mapper.map(getParameters().get(PARAMS_KEY_STRING)));
        assertEquals(getParameters().get(PARAMS_KEY_STRING__EMPTY),
                mapper.map(getParameters().get(PARAMS_KEY_STRING__EMPTY)));
        assertEquals(getParameters().get(PARAMS_KEY_STRING__UNTRIMMED),
                mapper.map(getParameters().get(PARAMS_KEY_STRING__UNTRIMMED)));
        assertEquals(getParameters().get(PARAMS_KEY_STRING__UNTRIMMED_EMPTY),
                mapper.map(getParameters().get(PARAMS_KEY_STRING__UNTRIMMED_EMPTY)));
        assertEquals(getParameters().get(PARAMS_KEY_STRING_BUILDER),
                mapper.map(getParameters().get(PARAMS_KEY_STRING_BUILDER)));
    }
    ...
    @Test
    void map3() {
        assertEquals(ANOTHER_DEFAULT_VALUE, mapper.map(getParameters().get(PARAMS_KEY_NO_KEY), ANOTHER_DEFAULT_VALUE));
        assertEquals(ANOTHER_DEFAULT_VALUE,
    ...
    void map6() {
        ...
        assertEquals(mapper.getDefaultValue(), mapper.map((String) getParameters().get(PARAMS_KEY_STRING), true, true));
    ...
    void map7() {
        assertEquals(ANOTHER_DEFAULT_VALUE,
                mapper.map((String) getParameters().get(PARAMS_KEY_STRING), false, false, ANOTHER_DEFAULT_VALUE));
        assertEquals(ANOTHER_DEFAULT_VALUE,
                mapper.map((String) getParameters().get(PARAMS_KEY_STRING), false, true, ANOTHER_DEFAULT_VALUE));
        assertEquals(ANOTHER_DEFAULT_VALUE,
                mapper.map((String) getParameters().get(PARAMS_KEY_STRING), true, false, ANOTHER_DEFAULT_VALUE));
        assertEquals(ANOTHER_DEFAULT_VALUE,
        ...
        assertEquals(ANOTHER_DEFAULT_VALUE,
                mapper.map((String) getParameters().get(PARAMS_KEY_STRING__EMPTY), false, true, ANOTHER_DEFAULT_VALUE));
        assertEquals(ANOTHER_DEFAULT_VALUE,
                mapper.map((String) getParameters().get(PARAMS_KEY_STRING__EMPTY), true, false, ANOTHER_DEFAULT_VALUE));
        assertEquals(ANOTHER_DEFAULT_VALUE,
                mapper.map((String) getParameters().get(PARAMS_KEY_STRING__EMPTY), true, true, ANOTHER_DEFAULT_VALUE));
    ...
    @Test
    void prepare() {
        assertNull(null, mapper.prepare((String) getParameters().get(PARAMS_KEY_NO_VALUE), false, false));
        assertNull(null, mapper.prepare((String) getParameters().get(PARAMS_KEY_NO_VALUE), false, true));
        assertNull(null, mapper.prepare((String) getParameters().get(PARAMS_KEY_NO_VALUE), true, false));
        assertNull(null, mapper.prepare((String) getParameters().get(PARAMS_KEY_NO_VALUE), true, true));
        ...
        assertEquals("", mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__EMPTY), false, false));
        assertNull(null, mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__EMPTY), false, true));
        assertEquals("", mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__EMPTY), true, false));
        assertNull(null, mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__EMPTY), true, true));

        assertEquals(getParameters().get(PARAMS_KEY_STRING__UNTRIMMED),
                mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__UNTRIMMED), false, false));
        assertEquals(getParameters().get(PARAMS_KEY_STRING__UNTRIMMED),
                mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__UNTRIMMED), false, true));
        assertEquals(((String) getParameters().get(PARAMS_KEY_STRING__UNTRIMMED)).trim(),
                mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__UNTRIMMED), true, false));
        assertEquals(((String) getParameters().get(PARAMS_KEY_STRING__UNTRIMMED)).trim(),
                mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__UNTRIMMED), true, true));

        assertEquals(getParameters().get(PARAMS_KEY_STRING__UNTRIMMED_EMPTY),
                mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__UNTRIMMED_EMPTY), false, false));
        assertEquals(getParameters().get(PARAMS_KEY_STRING__UNTRIMMED_EMPTY),
                mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__UNTRIMMED_EMPTY), false, true));
        assertEquals("", mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__UNTRIMMED_EMPTY), true, false));
        assertNull(null, mapper.prepare((String) getParameters().get(PARAMS_KEY_STRING__UNTRIMMED_EMPTY), true, true));
