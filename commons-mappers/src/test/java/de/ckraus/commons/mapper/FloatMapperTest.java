...
class FloatMapperTest {
    ...
    private Float getDefaultBigDecimal() {
        return ( ( BigDecimal ) getParameters().get( PARAMS_KEY_BIG_DECIMAL ) ).floatValue();
    }
    ...
    private Float getDefaultBigInteger() {
        return ( ( BigInteger ) getParameters().get( PARAMS_KEY_BIG_INTEGER ) ).floatValue();
    }
    ...
    private Float getDefaultByte() {
        return ( ( Byte ) getParameters().get( PARAMS_KEY_BYTE ) ).floatValue();
    }
    ...
    private Float getDefaultByte( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_BYTE_STRING ).toString() ).toString() ).floatValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Float getDefaultDouble() {
        return ( ( Double ) getParameters().get( PARAMS_KEY_DOUBLE ) ).floatValue();
    }
    ...
    private Float getDefaultFloat() {
        return ( ( Float ) getParameters().get( PARAMS_KEY_FLOAT ) );
    }
    ...
    private Float getDefaultInteger() {
        return ( ( Integer ) getParameters().get( PARAMS_KEY_INTEGER ) ).floatValue();
    }
    ...
    private Float getDefaultLong() {
        return ( ( Long ) getParameters().get( PARAMS_KEY_LONG ) ).floatValue();
    }
    ...
    private Float getDefaultLong( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_LONG_STRING ).toString() ).toString() ).floatValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Float getDefaultShort() {
        return ( ( Short ) getParameters().get( PARAMS_KEY_SHORT ) ).floatValue();
    }
