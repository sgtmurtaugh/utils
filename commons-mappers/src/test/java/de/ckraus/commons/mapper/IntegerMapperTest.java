...
class IntegerMapperTest {
    ...
    private Integer getDefaultBigDecimal() {
        return ( ( BigDecimal ) getParameters().get( PARAMS_KEY_BIG_DECIMAL ) ).intValue();
    }
    ...
    private Integer getDefaultBigInteger() {
        return ( ( BigInteger ) getParameters().get( PARAMS_KEY_BIG_INTEGER ) ).intValue();
    }
    ...
    private Integer getDefaultByte() {
        return ( ( Byte ) getParameters().get( PARAMS_KEY_BYTE ) ).intValue();
    }
    ...
    private Integer getDefaultByte( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_BYTE_STRING ).toString() ).toString() ).intValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Integer getDefaultDouble() {
        return ( ( Double ) getParameters().get( PARAMS_KEY_DOUBLE ) ).intValue();
    }
    ...
    private Integer getDefaultDouble( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_DOUBLE_STRING ).toString() ).toString() ).intValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Integer getDefaultFloat() {
        return ( ( Float ) getParameters().get( PARAMS_KEY_FLOAT ) ).intValue();
    }
    ...
    private Integer getDefaultFloat( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_FLOAT_STRING ).toString() ).toString() ).intValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Integer getDefaultInteger() {
        return ( ( Integer ) getParameters().get( PARAMS_KEY_INTEGER ) );
    }
    ...
    private Integer getDefaultLong() {
        return ( ( Long ) getParameters().get( PARAMS_KEY_LONG ) ).intValue();
    }
    ...
    private Integer getDefaultLong( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_LONG_STRING ).toString() ).toString() ).intValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Integer getDefaultShort() {
        return ( ( Short ) getParameters().get( PARAMS_KEY_SHORT ) ).intValue();
    }
    ...
    private Integer getDefaultShort( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_SHORT_STRING ).toString() ).toString() ).intValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
