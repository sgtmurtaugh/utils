...
class IntegerMapperTest {
    ...
    private final IntegerMapper mapper = () -> Integer.class;
    ...
    private Integer getDefaultBigDecimal(Locale locale) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse(getParameters().get(PARAMS_KEY_BIG_DECIMAL_STRING).toString()).toString()).intValue();
        }
    ...
    private Integer getDefaultBigInteger(Locale locale) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse(getParameters().get(PARAMS_KEY_BIG_INTEGER_STRING).toString()).toString()).intValue();
        }
        catch (ParseException pe) {
            pe.printStackTrace();
        }
