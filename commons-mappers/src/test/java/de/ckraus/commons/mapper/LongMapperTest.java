...
class LongMapperTest {
    ...
    private final LongMapper mapper = () -> Long.class;
    ...
    private Long getDefaultBigDecimal(Locale locale) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse(getParameters().get(PARAMS_KEY_BIG_DECIMAL_STRING).toString()).toString()).longValue();
        }
    ...
    private Long getDefaultBigInteger(Locale locale) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse(getParameters().get(PARAMS_KEY_BIG_INTEGER_STRING).toString()).toString()).longValue();
        }
        catch (ParseException pe) {
            pe.printStackTrace();
        }
