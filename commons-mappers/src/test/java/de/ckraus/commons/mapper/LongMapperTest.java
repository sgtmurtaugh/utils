...
class LongMapperTest {
    ...
    private Long getDefaultBigDecimal() {
        return ( ( BigDecimal ) getParameters().get( PARAMS_KEY_BIG_DECIMAL ) ).longValue();
    }
    ...
    private Long getDefaultBigInteger() {
        return ( ( BigInteger ) getParameters().get( PARAMS_KEY_BIG_INTEGER ) ).longValue();
    }
    ...
    private Long getDefaultByte() {
        return ( ( Byte ) getParameters().get( PARAMS_KEY_BYTE ) ).longValue();
    }
    ...
    private Long getDefaultByte( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_BYTE_STRING ).toString() ).toString() ).longValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Long getDefaultDouble() {
        return ( ( Double ) getParameters().get( PARAMS_KEY_DOUBLE ) ).longValue();
    }
    ...
    private Long getDefaultFloat() {
        return ( ( Float ) getParameters().get( PARAMS_KEY_FLOAT ) ).longValue();
    }
    ...
    private Long getDefaultFloat( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_FLOAT_STRING ).toString() ).toString() ).longValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Long getDefaultInteger() {
        return ( ( Integer ) getParameters().get( PARAMS_KEY_INTEGER ) ).longValue();
    }
    ...
    private Long getDefaultLong() {
        return ( ( Long ) getParameters().get( PARAMS_KEY_LONG ) );
    }
    ...
    private Long getDefaultLong( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_LONG_STRING ).toString() ).toString() ).longValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Long getDefaultShort() {
        return ( ( Short ) getParameters().get( PARAMS_KEY_SHORT ) ).longValue();
    }
    ...
    private Long getDefaultShort( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_SHORT_STRING ).toString() ).toString() ).longValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
