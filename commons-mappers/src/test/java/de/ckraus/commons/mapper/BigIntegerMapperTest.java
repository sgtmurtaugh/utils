...
class BigIntegerMapperTest {
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String)}
     */
    @Test
    void map() {
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, Locale)}
     */
    @Test
    void map1() {
        BigInteger defaultBigDecimal = this.getDefaultBigDecimal();
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, String)}
     */
    @Test
    void map2() {
        BigInteger defaultBigDecimal = this.getDefaultBigDecimal();
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, Locale, String)}
     */
    @Test
    void map3() {
        BigInteger defaultBigDecimal = this.getDefaultBigDecimal();
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, Locale, String, DecimalFormatSymbols)}
     */
    @Test
    void map4() {
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, String, DecimalFormatSymbols)}
     */
    @Test
    void map5() {
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, Number)}
     */
    @Test
    void map6() {
        BigInteger defaultBigDecimal = this.getDefaultBigDecimal();
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, Locale, Number)}
     */
    @Test
    void map7() {
        BigInteger defaultBigDecimal = this.getDefaultBigDecimal();
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, String, Number)}
     */
    @Test
    void map8() {
        BigInteger defaultBigDecimal = this.getDefaultBigDecimal();
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, Locale, String, Number)}
     */
    @Test
    void map9() {
        BigInteger defaultBigDecimal = this.getDefaultBigDecimal();
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, String, DecimalFormatSymbols, Number)}
     */
    @Test
    void map10() {
        DecimalFormatSymbols symbols = DecimalFormatSymbols.getInstance();
    ...
    /**
     * test for {@link BigIntegerMapper#map(Map, String, Locale, String, DecimalFormatSymbols, Number)}
     */
    @Test
    void map11() {
        DecimalFormatSymbols symbols = DecimalFormatSymbols.getInstance( locale );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String)}
     */
    @Test
    void map12() {
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, boolean, boolean, Number)}
     */
    @Test
    void map13() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, Locale)}
     */
    @Test
    void map14() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, String)}
     */
    @Test
    void map15() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, Locale, String)}
     */
    @Test
    void map16() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, Locale, String, DecimalFormatSymbols)}
     */
    @Test
    void map17() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, String, DecimalFormatSymbols)}
     */
    @Test
    void map18() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, Number)}
     */
    @Test
    void map19() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, Locale, Number)}
     */
    @Test
    void map20() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, String, Number)}
     */
    @Test
    void map21() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, Locale, String, Number)}
     */
    @Test
    void map22() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, String, DecimalFormatSymbols, Number)}
     */
    @Test
    void map23() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#map(String, Locale, String, DecimalFormatSymbols, Number)}
     */
    @Test
    void map24() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String)}
     */
    @Test
    void unformat() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, Locale)}
     */
    @Test
    void unformat1() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, String)}
     */
    @Test
    void unformat2() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, Locale, String)}
     */
    @Test
    void unformat3() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, Locale, String, DecimalFormatSymbols)}
     */
    @Test
    void unformat4() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, String, DecimalFormatSymbols)}
     */
    @Test
    void unformat5() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, Number)}
     */
    @Test
    void unformat6() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, Locale, Number)}
     */
    @Test
    void unformat7() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, String, Number)}
     */
    @Test
    void unformat8() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, Locale, String, Number)}
     */
    @Test
    void unformat9() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, String, DecimalFormatSymbols, Number)}
     */
    @Test
    void unformat10() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
    ...
    /**
     * test for {@link BigIntegerMapper#unformat(String, Locale, String, DecimalFormatSymbols, Number)}
     */
    @Test
    void unformat11() {
        String sBigDecimalString = ( String ) getParameters().get( PARAMS_KEY__BIG_DECIMAL_STRING );
