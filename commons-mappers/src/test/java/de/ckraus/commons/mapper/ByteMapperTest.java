...
class ByteMapperTest {
    ...
    private ByteMapper mapper = new ByteMapper() {
    };
    ...
    private Byte getDefaultBigDecimal() {
        return ( ( BigDecimal ) getParameters().get( PARAMS_KEY__BIG_DECIMAL ) ).byteValue();
    }
    ...
    private Byte getDefaultBigInteger() {
        return ( ( BigInteger ) getParameters().get( PARAMS_KEY__BIG_INTEGER ) ).byteValue();
    }
    ...
    private Byte getDefaultByte() {
        return ( Byte ) getParameters().get( PARAMS_KEY__BYTE );
    }
    ...
    private Byte getDefaultByte( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY__BYTE_STRING ).toString() ).toString() ).byteValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Byte getDefaultDouble() {
        return ( ( Double ) getParameters().get( PARAMS_KEY__DOUBLE ) ).byteValue();
    }
    ...
    private Byte getDefaultFloat() {
        return ( ( Float ) getParameters().get( PARAMS_KEY__FLOAT ) ).byteValue();
    }
    ...
    private Byte getDefaultFloat( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY__FLOAT_STRING ).toString() ).toString() ).byteValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Byte getDefaultInteger() {
        return ( ( Integer ) getParameters().get( PARAMS_KEY__INTEGER ) ).byteValue();
    }
    ...
    private Byte getDefaultLong() {
        return ( ( Long ) getParameters().get( PARAMS_KEY__LONG ) ).byteValue();
    }
    ...
    private Byte getDefaultLong( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY__LONG_STRING ).toString() ).toString() ).byteValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Byte getDefaultShort() {
        return ( ( Short ) getParameters().get( PARAMS_KEY__SHORT ) ).byteValue();
    }
    ...
    private Byte getDefaultShort( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY__SHORT_STRING ).toString() ).toString() ).byteValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
