...
class ByteMapperTest {
    ...
    private Byte getDefaultByte( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_BYTE_STRING ).toString() ).toString() ).byteValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Byte getDefaultFloat( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_FLOAT_STRING ).toString() ).toString() ).byteValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Byte getDefaultLong( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_LONG_STRING ).toString() ).toString() ).byteValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
    ...
    private Byte getDefaultShort( Locale locale ) {
        ...
        try {
            retValue = new BigDecimal(
                    format.parse( getParameters().get( PARAMS_KEY_SHORT_STRING ).toString() ).toString() ).byteValue();
        } catch ( ParseException pe ) {
            pe.printStackTrace();
        }
        return retValue;
